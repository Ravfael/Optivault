 ...
 * IDL can be found at `target/idl/optivault.json`.
 */
export type Optivault = {
  "address": "GAKRYNWn7YjHQB8ihiBYYn1QVp2g4vVt8wtTyEK65syZ",
  "metadata": {
    "name": "optivault",
    "version": "0.1.0",
    "spec": "0.1.0",
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "maxAllocationPerProtocol",
            "type": "u8"
          },
          {
            "name": "dailyRebalanceLimit",
            "type": "u8"
          },
          {
            "name": "rebalanceCountToday",
            "type": "u8"
          },
          {
            "name": "lastResetDay",
